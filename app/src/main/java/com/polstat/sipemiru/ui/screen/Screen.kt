...
sealed class Screen(
    ...
    object DaftarRuangan : Screen("daftarRuangan", "Daftar Ruangan", Icons.Outlined.List)
    ...
    object Register : Screen("register", "Register", Icons.Outlined.Person)

    object Login : Screen("login", "Login", Icons.Outlined.Person)

    object ItemsUser{
        val list = listOf(Peminjaman, DaftarRuangan, Profile)
    }

    object ItemsAdmin{
        val list = listOf(DaftarPeminjaman, Ruangan, DaftarRuangan, Profile)
    }
}